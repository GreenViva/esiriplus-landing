...
const features = [
  {
    titleKey: "features.consultation.title" as const,
    textKey: "features.consultation.text" as const,
    icon: (
  ...
  {
    titleKey: "features.messaging.title" as const,
    textKey: "features.messaging.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "features.video.title" as const,
    textKey: "features.video.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    textKey: "features.scheduling.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "features.ratings.title" as const,
    textKey: "features.ratings.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "features.records.title" as const,
    textKey: "features.records.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="section-container">
        ...
        <div ref={gridRef} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, i) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 ${feature.color}`}>
                {feature.icon}
              </div>
