...
const patientBenefits = [
  {
    titleKey: "platform.patient1.title" as const,
    textKey: "platform.patient1.text" as const,
    icon: (
  ...
  {
    titleKey: "platform.patient2.title" as const,
    textKey: "platform.patient2.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "platform.patient3.title" as const,
    textKey: "platform.patient3.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const doctorBenefits = [
  {
    titleKey: "platform.doctor1.title" as const,
    textKey: "platform.doctor1.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "platform.doctor2.title" as const,
    textKey: "platform.doctor2.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titleKey: "platform.doctor3.title" as const,
    textKey: "platform.doctor3.text" as const,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
